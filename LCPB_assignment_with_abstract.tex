...
\begin{figure}%[h]
    \centering
    \includegraphics[width=0.6\linewidth]{Pictures/experiment4/ground_truth.png}
...
In this work, two widely used clustering algorithms are considered:
\vspace{-0.5em}
\begin{itemize}[leftmargin=0pt, itemsep=0pt]
    \item[] \textbf{K-means}:
...
\begin{comment}[!t]
    \centering
    \includegraphics[width=0.4\linewidth]{Pictures/experiment1/t-SNE.png}
    \hskip 1mm
    \includegraphics[width=0.4\linewidth]{Pictures/experiment1/MDS.png}
    \caption{t-SNE (a) and MDS (b) visualizations colored using the true labels.}
...
\begin{figure}%[H]
    \centering
    \includegraphics[width=\linewidth]{Pictures/experiment1/K_means.png}
...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.8\linewidth]{Pictures/experiment1/Heatmap_NMI.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{Pictures/experiment1/DBSCAN.png}
...
\begin{equation}
    \max_K \text{NMI} = \text{NMI}(K = 3) \approx 0.90,
\end{equation}
